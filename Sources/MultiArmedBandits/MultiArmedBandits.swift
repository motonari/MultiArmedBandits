...
struct MultiArmedBandits {
    ...
    static func main() async {
        await epsilonGreedyTest(
            ...
            testCases: [
                TestCase(title: "ε=0.10", exploration: 0.10, stepSize: .average),
                TestCase(title: "ε=0.01", exploration: 0.01, stepSize: .average),
                TestCase(title: "ε=0.00", exploration: 0.00, stepSize: .average),
            ],
            stepCount: 1000,
            runCount: 2000
        )
        ...
        await epsilonGreedyTest(
            baseName: "initValues",
            title: "Average Performance of different initial values",
            testCases: [
                TestCase(
                    title: "init Q = 0.0",
                    exploration: 0.0,
                    stepSize: .average,
                    unstationality: false,
                    initialValue: 0.0
                ),
